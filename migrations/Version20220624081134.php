 ...
 */
final class Version20220624081134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE me_films (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE me_films_user (me_films_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_C7223B619C56E4C7 (me_films_id), INDEX IDX_C7223B61A76ED395 (user_id), PRIMARY KEY(me_films_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE me_films_films (me_films_id INT NOT NULL, films_id INT NOT NULL, INDEX IDX_FB13D3469C56E4C7 (me_films_id), INDEX IDX_FB13D346939610EE (films_id), PRIMARY KEY(me_films_id, films_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
